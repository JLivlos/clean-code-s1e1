...
var editTask = function() {
    ...
    label.classList.toggle("task-label_edit");
    editInput.classList.toggle("task-text_edit");
};
...
var taskCompleted = function() {
    ...
    var listItem = this.parentNode;
    listItem.querySelector(".task-label").classList.add('task-label_complited')
...
var taskIncomplete = function() {
    ...
    var listItem = this.parentNode;
    listItem.querySelector(".task-label").classList.remove('task-label_complited');
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem, taskCompleted);
}
